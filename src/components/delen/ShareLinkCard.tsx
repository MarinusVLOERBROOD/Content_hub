...
import { Copy, RotateCcw, Clock, CheckCircle2, XCircle, Trash2 } from "lucide-react";
import { revokeShareLink, deleteShareLink } from "@/actions/shares";
        ...
        <div className="flex gap-2">
          ...
          {!isActive && (
            <button
              ...
              disabled={isPending}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs border border-red-200 rounded-lg hover:bg-red-50 text-red-500 disabled:opacity-50"
            >
              <Trash2 size={12} />
              Verwijderen
            </button>
